...
class IPTMP_Map_Posts {
	...
	private function iptmp_add_default_options() {
		...
		$default_values = array("iptmp_map_address"=>"","iptmp_map_width"=>"75","iptmp_map_height"=>"300","iptmp_map_usermsg"=>"To update location, drag marker, click on map or manually enter latitude and longitude; then save the post (Save Draft, Publish or Update).","iptmp_opencage_key"=>"","iptmp_map_zoom"=>"0","iptmp_map_lat"=>"0.00","iptmp_map_long"=>"0.00");
